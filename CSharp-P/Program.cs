...
namespace CSharp_P
{
    internal class Program
    {
        ...
        {
            ListNode first=new ListNode();//新链表
            ListNode curr = first;
        ...
        static int[] ConvertStr2Array(string s)
        {
            string[] strs = s.Split(',');
        ...
        static TreeNode ConvertArray2Link(int[] nums)
        {
            return Utils.ConvertArray2Link(nums);
        }
        static TreeNode treeNode(int var)
        {
